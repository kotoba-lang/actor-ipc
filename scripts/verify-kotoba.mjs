...
if (web.kotobaArtifact.requiredCapabilities.length !== 0)
  throw new Error("actor-ipc bounded-clock Web graph requested a capability");
if (web.instantiateKotoba().main() !== 42n) throw new Error("actor-ipc Web main mismatch");
...
if (wasm.instance.exports.main() !== 42n) throw new Error("actor-ipc Wasm main mismatch");

console.log("actor-ipc: bounded clock Web/Wasm conformance passed");
